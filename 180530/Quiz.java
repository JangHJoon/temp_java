...
class Quiz2 extends JFrame{
	...
	private void setDisplay(){
		...
		JPanel pnlNorthWest = new JPanel(new GridLayout(5,1,10,10));
		JPanel pnlNorthCenter = new JPanel(new GridLayout(5,1,10,10));
		JPanel pnlNorthEast = new JPanel(new GridLayout(5,1,10,10));
		...
		pnlCenter.setBorder(new TitledBorder(new EmptyBorder(0,0,0,0), "자기소개"));
